...
unitTangent = [c2(1)-c1(1), c2(2)-c1(2)] / d;%ch? ph??ng c?a ???ng c1c2
unitNormal = [c1(2)-c2(2), c2(1)-c1(1)] / d;%pháp tuy?n c?a c1c2                   
if (flag == -1)
    % Internal Common Tangents
    theta=acos((r1+r2)/d);
    if rho==-1
        p_1=c1+unitTangent*r1*cos(theta)+unitNormal*r1*sin(theta);%c1p1 = c1 +r*cos*unitTangent
