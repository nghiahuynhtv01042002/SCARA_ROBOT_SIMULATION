...
fill3([(robot.a(1)+robot.a(2))*cos(theta1) 0],[(robot.a(1)+robot.a(2))*sin(theta1) 0],(robot.d(1)-d3_max)*ones(1,182),[113, 125, 140]/255,'FaceAlpha',0.15);
fill3([(robot.a(1)+robot.a(2))*cos(theta1) 0],[(robot.a(1)+robot.a(2))*sin(theta1) 0],robot.d(1)*ones(1,182),[113, 125, 140]/255,'FaceAlpha',0.15);
